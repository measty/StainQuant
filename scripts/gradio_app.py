...
from training.utils import knockout_visualization, one_only_visualization


def load_model(ckpt_path: str, config_path: str = "configs/default.yaml"):
...
def main():
    ...
    parser.add_argument("--config", default="ckpt_dir")
    args = parser.parse_args()

    model, device = load_model(args.ckpt, args.config if args.config != "ckpt_dir" else Path(args.ckpt).parent / "config.yaml")
